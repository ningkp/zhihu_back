...
from ..query_strategy.query_labels import QueryInstanceQBC, \
         QueryInstanceUncertainty, QueryInstanceRandom, QueryExpectedErrorReduction, QueryInstanceQUIRE, \
          QueryInstanceBMDR, QueryInstanceSPAL, QueryInstanceLAL, QueryExpectedErrorReduction
